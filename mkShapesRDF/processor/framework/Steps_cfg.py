Steps = {
   ...
   "DATAl2loose2022v12__addTnPMuon": {
    ...
    "DATAl2loose2025v15__addTnPMuon": {
        "isChain" : True,
        "do4MC" : False,
        "do4Data" : True,
        "selection" : '"((nElectron+nMuon)>1)"',
    ...
    "DATAl2loose2025v15__addTnPElectron": {
        "isChain" : True,
        "do4MC" : False,
        "do4Data" : True,
        "selection" : '"((nElectron+nMuon)>1)"',
...
##### testrecipes ####
    ...
    "jetSelUL": {
        ...
        "declare": 'jetSel = lambda : JetSel(2,15.0,4.7,False)',
        "module": "jetSel()",
    },
    ...
    "jetIDMaker": {
        ...
        "do4MC": True,
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.JetIDMaker",
        "declare": 'jetIDMaker = lambda : JetIDMaker("RPLME_CMSSW")',
        "module": "jetIDMaker()",
    },
    ...
    "jetSelMaskFilter": {
        ...
        "declare": 'jetSelMask = lambda : JetSelMask(2,15.0,4.7,False,"RPLME_CMSSW", doMask = True, eventMask=True)',
        "module": "jetSelMask()",
    },
